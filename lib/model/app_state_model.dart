...
class AppStateModel extends foundation.ChangeNotifier{
  ...
  double get shoppingCost{
    return _shoppingCostPerItem * _productsInCart.values.fold(0, (accumulator, itemCount){
  ...
  double get totalCost{
    return subtotalCost + shoppingCost + tax;
  }
